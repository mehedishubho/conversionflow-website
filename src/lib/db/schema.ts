...
export const blogPostLocaleEnum = pgEnum("blog_post_locale", [
  "en",
  "bn",
]);
...
export const blogCategories = pgTable("blog_categories", {
  ...
  locale: blogPostLocaleEnum("locale").notNull().default("bn"),
  createdAt: timestamp("created_at").notNull().defaultNow(),
  updatedAt: timestamp("updated_at")
    .notNull()
    .defaultNow()
...
export const blogPosts = pgTable(
  "blog_posts",
  {
    ...
    locale: blogPostLocaleEnum("locale").notNull().default("bn"),
    translatedPostId: uuid("translated_post_id"),
  ...
  (t) => [
    unique("blog_posts_slug_locale_unique").on(t.slug, t.locale),
...
export const blogPostsRelations = relations(blogPosts, ({ one }) => ({
  ...
  translatedPost: one(blogPosts, {
    fields: [blogPosts.translatedPostId],
    references: [blogPosts.id],
    relationName: "translatedPost",
  }),
}));
