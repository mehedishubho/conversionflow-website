...
export function UserDropdown() {
  ...
  return (
    <div className="relative">
      ...
      >
        <span className="mr-3 overflow-hidden rounded-full h-11 w-11 flex items-center justify-center bg-brand-50 text-brand-500 dark:bg-brand-500/[0.12] dark:text-brand-400 font-semibold text-sm">
          {user.image ? (
            <img
              src={user.image}
              alt={user.name || "User"}
