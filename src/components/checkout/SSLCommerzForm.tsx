...
export default function SSLCommerzForm({
  ...
  const handlePayment = async () => {
    ...
    try {
      ...
      setError("Unable to connect to SSL Commerz. Please try again.");
    } finally {
      setLoading(false);
    }
  };
  ...
  return (
    <div className="space-y-4">
      ...
      <button
        ...
        disabled={loading}
        className="inline-flex items-center justify-center w-full px-5 py-3.5 text-sm font-medium rounded-lg bg-[#1A5F9E] text-white shadow-theme-xs hover:bg-[#154a7e] disabled:opacity-50 disabled:cursor-not-allowed transition"
      >
        {loading ? (
          <>
